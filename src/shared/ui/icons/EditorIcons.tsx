...
/**
 * Common Editor Icons
 * Used across multiple features (Bio, Text, etc.)
 */
...
export const TriangleAlertIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const StrikethroughIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M16 4h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2V4" />
        <path d="M4 12h16" />
        <path d="M4 16h2a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2H4" />
    </svg>
)
