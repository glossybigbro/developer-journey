...
import { RADAR_CONFIG } from '@/shared/config/uiConstants'
...
export function CanvasRadar({ hasSignal, color, signalColor, signalGlowColor }: CanvasRadarProps) {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            RADAR_CONFIG.concentricRatios.forEach((ratio: number) => {
                ctx.beginPath()
            ...
            // Note: sweepGradientStops are strings like 'CC', '66', '00' (hex alpha)
    ...
    }, [hasSignal, color, signalColor, signalGlowColor])
